...
[![Build Status](https://travis-ci.org/dimchansky/genny.svg?branch=master)](https://travis-ci.org/dimchansky/genny) [![GoDoc](https://godoc.org/github.com/dimchansky/genny/parse?status.png)](http://godoc.org/github.com/dimchansky/genny/parse)

Install:

```
go install github.com/dimchansky/genny
```

Develop:
```
go get github.com/stretchr/testify/assert # necessary to run tests
go get github.com/dimchansky/genny
go test github.com/dimchansky/genny/...
```
...
To see a real example of how to use `genny` with `go generate`, look in the [example/go-generate directory](https://github.com/dimchansky/genny/tree/master/examples/go-generate).
...
Given [this generic Go code](https://github.com/dimchansky/genny/tree/master/examples/queue) which compiles and is tested:

```
package queue

import "github.com/dimchansky/genny/generic"
...
Check out the [test code files](https://github.com/dimchansky/genny/tree/master/parse/test) for more real examples.
...
### Contributions
  ...
  * See the [API documentation for the parse package](http://godoc.org/github.com/dimchansky/genny/parse)
  * Please do TDD
  * All input welcome
